...
1. Убедитесь, что Ваша видеокарта поддерживает vulkan API. Проверить это Вы можете на официальном [сайте](https://vulkan.gpuinfo.org/) vulkan'a. Если не поддерживается, то ставьте обычную версию MercuryMC.
